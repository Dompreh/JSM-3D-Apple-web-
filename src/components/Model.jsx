...
import { animateWithGsapTl } from '../utils/animateWithGsapTl'
...
function Model() {
  ...
  //get modelview effects when object size changes
  ...
  useEffect(()=>{
    ...
    if(size === "small"){
      animateWithGsapTl(tl, large, largeRotation, "#view1", "#view2", {
        ...
        <div className='flex flex-col items-center mt-5'>
          <div className='w-full h-[75vh] md:h-[90vh] relative overflow-hidden'>
            ...
            <ModelView
              ...
              size={size}
            />
            {/* how to display multiple models */}
